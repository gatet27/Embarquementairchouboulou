...
<title>Annonce Airchouboulou – Embarquement Tahiti</title>
<style>
  :root{
    --bg:#0b1220;
    --panel:#111a2e;
  ...
  *{box-sizing:border-box}
  body{
    margin:0; font-family: system-ui, -apple-system, Segoe UI, Roboto, "Helvetica Neue",
    Arial, "Noto Sans", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
    background: radial-gradient(1200px 600px at 70% -10%, #1a2850 0%, var(--bg) 55%);
    color:var(--text);
  ...
  .brand{display:flex; align-items:center; gap:14px; font-weight:700; letter-spacing:.5px}
  .logo{
    width:42px; height:42px; border-radius:10px; display:grid; place-items:center;
    background: conic-gradient(from 210deg, #44c7ff, #8df5ff, #44c7ff);
    color:#002a3a; font-weight:900; box-shadow:inset 0 0 18px rgba(0,0,0,.25);
  }
  ...
  .hint{font-size:.78rem; letter-spacing:.06em; color:var(--muted); text-transform:uppercase}
  .big{font-size:1.9rem; font-weight:800; letter-spacing:.5px}
  .dest{font-size:2.1rem}
  .status{
    display:inline-flex; align-items:center; gap:10px; font-weight:800;
    font-size:1.4rem; padding:10px 14px; border-radius:999px;
